...
def lclz_bbox_1d(obj_s, obj_e, crp_s, crp_e, max_size):
    lcl_obj_s = 0
    lcl_obj_e = 0
        ...
        with open(read_file, "r") as rf:
            ...
            for line in lines:
                ...
                for i in range(crp_num_y):
                    ...
                    lcl_obj_sy, lcl_obj_ey = lclz_bbox_1d(obj_sy, obj_ey, crp_sy, crp_ey, LOCALIZE_HEIGHT)
                    ...
                    for j in range(crp_num_x):
                        ...
                        lcl_obj_sx, lcl_obj_ex = lclz_bbox_1d(obj_sx, obj_ex, crp_sx, crp_ex, LOCALIZE_WIDTH)
